...
<div  class="z-0 mt-20 px-52 element text-white"> 
 <h1 on:mouseover={handleChange} on:mouseout={handleChange} class="text-9xl font-extrabold ">THE PLATFORM YOUR METAVERSE IS BUILT ON</h1>
	
</div>

<div class="mt-40 px-52"> 
	<h1 class="p-28 pb-5 font-bold text-4xl">The world's most successful brands trust the Vatom platform to help them create,
		 own, promote, and sell within their own Metaverse.</h1>	 

</div>
<div class=" px-52"> 
	<script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
	<lottie-player class="m-auto" src="https://assets2.lottiefiles.com/packages/lf20_2omr5gpu.json"  background="transparent"  speed="1"  style="width: 500px; height: 500px;"  loop autoplay></lottie-player>
</div>

<div class="mt-24 px-52"> 
	<div class="p-32">
...
<div class="mt-40 mb-72 px-52 relative"> 
  ...
  <h1 class="text-6xl text-orange-500 font-extrabold p-10 px-56">CREATE TRADITIONAL NFT’S</h1>
  <h2 class="text-3xl ml-20 px-44">Using the Vatom Studio feature easily create, promote, and sell your NFTs.</h2>
</div>
</div>


<div class="pt-40 px-52 flex flex-row"> 
	<div> 
	  <h1 class="text-6xl text-orange-500 font-extrabold p-10 px-20">CREATE SMART NFT’S</h1>
      <h2 class="text-2xl px-20">Only the Vatom platform enables next-generation ‘Smart NFTs”, programmable digital objects that you can see,
...
<div class="mt-40 px-52 flex flex-row"> 
...
<div class="mt-40 px-52 mb-20"> 
	<div>
	<script src="https://unpkg.com/@lottiefiles/lottie-player@latest/dist/lottie-player.js"></script>
   <lottie-player src="https://assets8.lottiefiles.com/private_files/lf30_atd7nv5g.json"  background="transparent"  speed="1"  style="width: 1000px; height: 700px;"  loop  autoplay></lottie-player>
</div>
