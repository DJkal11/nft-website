...
<nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
	<div class="container flex flex-wrap justify-between items-center mx-auto">
	  <a href="/" class="flex items-center">
		  <img src={NewLogo} class="mr-3 h-6 sm:h-9" alt="Flowbite Logo">
		  <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Friend A Labs</span>
	  </a>
	  <button on:click={showMenu} data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="navbar-default" aria-expanded="false">
	  ...
	  <div class="hidden w-full md:block md:w-auto" id="navbar-default">
		<ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
			<li class="{tab === "home" ? 'border-blue-500 border-b-2 pr-1 transition-all' : 'border-blue-500 hover:border-b-2 transition-all'}">
		  ...
		  <li class="{tab === "about" ? 'border-blue-500 border-b-2 pr-1 transition-all' : 'border-blue-500 hover:border-b-2 transition-all'}">
		  ...
		  <li class="{tab === "market" ? 'border-blue-500 border-b-2 pr-1 transition-all' : 'border-blue-500 hover:border-b-2 transition-all'}">
			<a href="/marketplace" on:click={() => tab = "market"} class="block py-2 pr-4 pl-3 text-gray-700 rounded  md:p-0 ">PRODUCTS</a>
		  </li>
		  <li class="{tab === "blog" ? 'border-blue-500 border-b-2 pr-1 transition-all' : 'border-blue-500 hover:border-b-2 transition-all'}">
			<a href="/" on:click={() => tab = "blog"} class="block py-2 pr-4 pl-3 text-gray-700 rounded md:p-0 ">BLOG</a>
		  </li>
		  <li class="{tab === "faq" ? 'border-blue-500 border-b-2 pr-1 transition-all' : 'border-blue-500 hover:border-b-2 transition-all'}">
	  ...
	  <div class="{menu? 'hidden w-full' : 'block sm:hidden w-full'}" id="navbar-default">
		<ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
		  <li on:click={showMenu} class="{tab === "home" ? 'border-orange-500 border-b-2 transition-all' : ''}">
			<a href="/" on:click={() => tab = "home"} class="block py-2 pr-4 pl-3 text-gray-700 rounded md:bg-transparent md:p-0 dark:text-white" aria-current="page">Home</a>
		  </li>
		  <li on:click={showMenu} class="{tab === "about" ? 'border-orange-500 border-b-2 transition-all' : ''}">
		  ...
		  <li on:click={showMenu} class="{tab === "market" ? 'border-orange-500 border-b-2 transition-all' : ''}">
